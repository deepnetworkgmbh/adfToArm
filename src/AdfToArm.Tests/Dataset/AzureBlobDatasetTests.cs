...
{
    [TestClass]
    public class AzureBlobDatasetTests
    {
        private const string FullFilePath = @"./samples/datasets/azure_blob_full.json";
        private const string MinimumFilePath = @"./samples/datasets/azure_blob_min.json";
        ...
        [TestMethod]
        public void DataSetType_ShouldBe_AzureBlob()
        {
            // Arrange
            // Act
            var result = AdfSerializer.Deserialize(FullFilePath);
            ...
            // Assert
            result.value.ShouldBeAssignableTo<AzureBlob>();
        }
        ...
        public void AdfSerializer_ShouldParse_MinimumSetOfProperties()
        {
            ...
            dataset.Properties.Type.ShouldBe(DataSetType.AzureBlob);
